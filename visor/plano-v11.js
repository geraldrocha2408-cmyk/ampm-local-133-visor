(() => {
  ...
  dialog.innerHTML=`<div id="plan-toolbar"><h2 id="plan-title">AMPM Layout RD · 136,42 m² · Plano</h2><button id="plan-minus" aria-label="Alejar plano">−</button><output id="plan-zoom" aria-live="polite">100%</output><button id="plan-plus" aria-label="Acercar plano">+</button><button id="plan-fit">Ver lámina completa</button><button id="plan-print">Imprimir</button><a href="AMPM Layout RD - 136.42 m2 - Plano.pdf" download="AMPM Layout RD - 136.42 m2 - Plano.pdf" type="application/pdf">Descargar plano PDF</a><button id="plan-close">Volver al 3D</button></div><div id="plan-viewport" tabindex="0" aria-label="Plano ampliable. Usa más y menos para acercar o alejar, flechas para desplazar."><div id="plan-message" role="status">Cargando plano…</div></div><p id="plan-status">Rueda o botones para ampliar · arrastra para desplazar · escala de impresión 1:40 en A2 · cotas del modelo, verificar en sitio.</p>`;
